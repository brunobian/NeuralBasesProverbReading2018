...
hold on;
    errorPatch = patch(Xcoords,Ycoords,color,'FaceAlpha',alpha, 'LineStyle', 'none');% draw error bar patch
    dataLine = plot(x,y, lineType, 'color',color,'linewidth',2);% plot data line
hold off;
